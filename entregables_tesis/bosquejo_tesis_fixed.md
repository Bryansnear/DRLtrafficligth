...
### Conceptos de Tránsito Vehicular
...
### SUMO: Características y Arquitectura
...
> [!NOTE] > **Figura 1.1:** Esquema de interacción entre el entorno de simulación y el agente de control.
> _[Insertar aquí diagrama de la intersección mostrando Detectores (puntos de análisis) y Semáforos (puntos de control)]_
...
### Fundamentos de Aprendizaje por Refuerzo (RL)
...
### Deep Reinforcement Learning y PPO
...
#### Consolidación de PPO y Benchmarking (2020-2022)
...
#### Enfoques Multi-Objetivo y Cooperativos (2023-2024)
...
#### Integración y Nuevas Tendencias (2025)
...
### Modelado y configuración de SUMO
...
### Arquitectura y configuración del algoritmo PPO
...
### Flujo de entrenamiento y simulación
...
### Análisis de Estabilidad y Colas
...
### Robustez ante variaciones de tráfico
...
### Análisis de sensibilidad del reward
