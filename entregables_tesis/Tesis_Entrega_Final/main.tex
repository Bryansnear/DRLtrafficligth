...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\footnotesize Escuela de Ciencias Matemáticas y Computacionales} 
\fancyhead[R]{\footnotesize Universidad Yachay Tech}   
\fancyfoot[R]{\footnotesize Proyecto de Titulación}  
\fancyfoot[C]{\thepage}  % center
\fancyfoot[L]{\footnotesize Maestría en Inteligencia Artificial}  %left
...
\vspace*{0.75cm}
Trabajo de integración curricular presentado como requisito para la obtención del título de Maestría en Inteligencia Artificial}\\
\vspace*{1.75cm}
